...
public class OrderLogic {
    ...
    /**
     * The constructor for this logic class. it accepts the relevant databases
     * @param productDB
     * @param orderableDB
     */
    ...
    /**
     * Lets you change the price of a product that can be ordered
     * @param name the name of the product to be changed
     * @param price the new price of the product
     * @return errors generated by the operation
     */
    ...
    /**
     * lets you change the shelf life of a product that can be ordered
     * @param name the name of the product to be updated
     * @param shelfLife the new shelf life of the product
     * @return any errors
     */
    ...
    /**
     * Lets you add a new product that CAN be ordered
    ...
    /**
     * remove a product so that it can no longer be ordered
